...
(entity, entity_value, entity_value_label, entity_status, entity_status_label, entity_filter, entity_date_start, entity_date_end, entity_recipient)
VALUES
( 'civicrm_activity', 'activity_type', 'Activity Type', 'activity_status', 'Activity Status', NULL, 'activity_date_time', NULL, 'activity_contacts'),
( 'civicrm_participant', 'event_type', 'Event Type', 'civicrm_participant_status_type', 'Participant Status', NULL, 'event_start_date', 'event_end_date', 'event_contacts'),
( 'civicrm_participant', 'civicrm_event', 'Event Name', 'civicrm_participant_status_type', 'Participant Status', NULL, 'event_start_date', 'event_end_date', 'event_contacts'),
( 'civicrm_membership', 'civicrm_membership_type', 'Membership Type', 'auto_renew_options', 'Auto Renew Options', NULL, 'membership_join_date', 'membership_end_date', NULL),
( 'civicrm_participant', 'event_template', 'Event Template', 'civicrm_participant_status_type', 'Participant Status', NULL, 'event_start_date', 'event_end_date', 'event_contacts'),
( 'civicrm_contribution', 'financial_type_id', 'Financial Type', 'contribution_status_id', 'Contribution Status', 'campaign_id', 'contribution_receive_date', NULL, NULL);
